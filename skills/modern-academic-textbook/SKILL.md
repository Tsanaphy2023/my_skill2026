...
* **ตำแหน่ง Caption:** คำบรรยายตาราง (`\caption{...}`) ต้องอยู่ **ด้านบน** และ **จัดชิดขอบขวา** ของตาราง/หน้ากระดาษ (Flush Right ด้วย `justification=raggedleft, singlelinecheck=false`) เสมอ (ต่างจากภาพที่อยู่ด้านล่างและจัดกึ่งกลาง)
